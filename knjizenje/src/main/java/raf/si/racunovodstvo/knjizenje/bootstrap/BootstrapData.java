...
public class BootstrapData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        kg1.setBrojKonta("3");
        kg1.setNazivKonta("Naziv kontne grupe 3");
        KontnaGrupa kg2 = new KontnaGrupa();
        kg2.setBrojKonta("30");
        kg2.setNazivKonta("Naziv kontne grupe 30");
        KontnaGrupa kg3 = new KontnaGrupa();
        kg3.setBrojKonta("301");
        kg3.setNazivKonta("Naziv kontne grupe 301");
        KontnaGrupa kg4 = new KontnaGrupa();
        kg4.setBrojKonta("302");
        kg4.setNazivKonta("Naziv kontne grupe 302");
        KontnaGrupa kg5 = new KontnaGrupa();
        kg5.setBrojKonta("306");
        kg5.setNazivKonta("Naziv kontne grupe 306");
        KontnaGrupa kg6 = new KontnaGrupa();
        kg6.setBrojKonta("309");
        kg6.setNazivKonta("Naziv kontne grupe 309");
        KontnaGrupa kg7 = new KontnaGrupa();
        kg7.setBrojKonta("31");
        kg7.setNazivKonta("Naziv kontne grupe 31");
        KontnaGrupa kg8 = new KontnaGrupa();
        kg8.setBrojKonta("32");
        kg8.setNazivKonta("Naziv kontne grupe 32");
        KontnaGrupa kg9 = new KontnaGrupa();
        kg9.setBrojKonta("33");
        kg9.setNazivKonta("Naziv kontne grupe 33");
